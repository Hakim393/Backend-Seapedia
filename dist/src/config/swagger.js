...
const swaggerOptions = {
    definition: {
        ...
        info: {
            ...
            version: "1.0.0",
            description: "Dokumentasi REST API untuk SEAPEDIA, marketplace multi-seller dengan fitur authentication, store, product, cart, checkout, order status, review, dan admin dashboard.",
            contact: {
        ...
        tags: [
            ...
            {
                name: "Cart",
                description: "Endpoint keranjang belanja. Satu cart hanya boleh berisi produk dari satu toko.",
            },
            {
                name: "Orders",
                description: "Endpoint checkout, daftar pesanan, detail pesanan, dan update status pesanan.",
            },
            {
                name: "Reviews",
                description: "Endpoint review produk dan review aplikasi dengan input yang disanitasi.",
            },
            {
                name: "Admin",
        ...
        components: {
            securitySchemes: {
                bearerAuth: {
                    ...
                    scheme: "bearer",
                    bearerFormat: "JWT",
                    description: "Masukkan JWT token dari endpoint login. Format: Bearer <token>",
                },
            },
            schemas: {
                ErrorResponse: {
