 ...
 */
router.post("/categories", auth_middleware_1.authMiddleware, (0, auth_middleware_1.authorizeRoles)(client_1.Role.ADMIN), product_controller_1.createCategory);
/**
 * @swagger
 ...
 *         description: Nama kategori sudah digunakan
 */
router.patch("/categories/:id", auth_middleware_1.authMiddleware, (0, auth_middleware_1.authorizeRoles)(client_1.Role.ADMIN), product_controller_1.updateCategory);
/**
 * @swagger
 * /api/products/categories/{id}:
 *   delete:
 ...
 *         description: Kategori tidak ditemukan
 */
router.delete("/categories/:id", auth_middleware_1.authMiddleware, (0, auth_middleware_1.authorizeRoles)(client_1.Role.ADMIN), product_controller_1.deleteCategory);
/**
 * @swagger
 ...
 */
router.get("/seller/my-products", auth_middleware_1.authMiddleware, (0, auth_middleware_1.authorizeRoles)(client_1.Role.SELLER), product_controller_1.getSellerProducts);
/**
 * @swagger
 * /api/products:
 *   get:
 ...
 */
router.post("/", auth_middleware_1.authMiddleware, (0, auth_middleware_1.authorizeRoles)(client_1.Role.SELLER), product_controller_1.createProduct);
/**
 * @swagger
 ...
 */
router.patch("/:id", auth_middleware_1.authMiddleware, (0, auth_middleware_1.authorizeRoles)(client_1.Role.SELLER), product_controller_1.updateProduct);
/**
 * @swagger
 * /api/products/{id}:
 *   delete:
 ...
 *         description: Produk tidak ditemukan atau bukan milik toko seller
 */
router.delete("/:id", auth_middleware_1.authMiddleware, (0, auth_middleware_1.authorizeRoles)(client_1.Role.SELLER), product_controller_1.deleteProduct);
